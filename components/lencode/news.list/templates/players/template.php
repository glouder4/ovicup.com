	...
	<div class ="players-tabulation main-tabulation">
		<div class = "tabulation-wrapper">
				...
				<tr class ="table-info-row">
					...
					<td>
						...
						Голы
                                    ...
                                    <?} else if ($_REQUEST['role'] == 'assistant') {?>
                                    <td>
						Г+П
					</td>
                                    <td>
			...
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				<?php 
				if ($arItem["PROPERTIES"]["DATE_BIRTH"]["VALUE"]) {
			...
			$club_el = $resClub->GetNext();
				...
				<tr class ="table-professionals-player">
					...
					<td><?= $arItem['SCORE'] ?></td>
                                        <?} else {?>
                                        <td><?= $arItem["PROPERTIES"]["DATE_BIRTH"]["VALUE"] ?></td>
                                        <td><?= $arItem["PROPERTIES"]["DATE_BIRTH"]["VALUE"] ? $final_years . ' лет' : '' ?></td>
                                        <?}?>
				</tr>
