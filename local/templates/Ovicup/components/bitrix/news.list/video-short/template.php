...
<section class="translations main__section">
	<div class="title__head">
		<h2 class="translations__title title">Трансляции</h2>
		<div class="translations link link--right"><a href="/press-center/translations/">Вся трансляции</a></div>
	</div>
